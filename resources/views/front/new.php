				...
				@endforeach
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<!-- <li class="drop-link">
								<a href="blog.html">Workshop <i class="fa fa-angle-down"></i></a>
								<ul class="dropdown">
									<li>
										<a href="{{url('front/MPCT')}}">Xiaomi MI Company</a>
									</li>
									<li>
										<a href="blog-grid-3.html">Bentchair Company</a>
									</li>
									<li>
										<a href="blog.html">MPCT College</a>
									</li>
									<li>
										<a href="single-post.html">RJIT College</a>
									</li>
								</ul>
							</li> -->
						...
						<a href="{{url('front/signup')}}" class="register-modal-opener ">
							<input style="border-radius:15px;margin-left:10px;width:100px;" class="btn btn-info" type="submit" name="submit" value="Signup"></a>
						<a href="{{url('front/login')}}" class="register-modal-opener ">
							<input style="border-radius:15px;margin-left:10px;width:100px;" class="btn btn-info" type="submit" name="submit" value="Login"></a>
					</div>
				</div>
			</nav>
