...
@section("content")
  ...
  <td>
    <a href="{{url('admin/banner_edit/'.$x->id)}}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
    <br><br>
    <a href="{{url('admin/banner_delete/'.$x->id)}}"><i class="fa fa-trash" aria-hidden="true"></i></a>
  </td>
</tr>
  ...
  <span aria-hidden="true">&times;</span>
      ...
      <div class="modal-body">
        ...
        <form  method="post" action="{{url('admin/banner_save')}}" enctype="multipart/form-data">

           @csrf
    
                  Title: <input class="form-control" type="text" name="title" placeholder="Enter Title">
                  <br>
